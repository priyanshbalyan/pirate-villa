  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-neutral-100 text-white dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
        ...
        day_disabled: "text-slate-600 bg-slate-600/20 rounded-none  opacity-50 cursor-not-available",
        day_range_middle:
