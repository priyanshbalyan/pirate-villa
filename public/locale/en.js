export default {
  ...
  north_villa_page_feature_headers: ['Essentials', 'Laundry', 'Safety', 'Suitability', 'Pets'],
  ...
  north_villa_page_testimonial_header_name: ['Angie C.', 'Jackie P.', 'Robert B.', 'Pamela C.', 'Matthew S.', 'Tricia C.'],
  north_villa_page_testimonial_header_subtitle: ['Beautiful Home', 'Perfect Location, Comfort and Cleaninenss', 'Wonderfull Villa', '2023 St John Family Trip', 'Awesome time', 'St John Lovely Unit Short Walk From Beach'],
  ...
  terms_and_conditions_points: ['Booking and Payment', 'Cancellation Policy', 'Check-in and Check-out', 'House Rules', 'Damages and Liability', 'Maintenance and Repairs', 'Amenities and Services'],
  ...
  footer_columns_title: ['Address', 'Phone', 'Email', 'Hosted by', 'Languages'],
  footer_columns_value: ['Cruz Bay, St. John Virgin Islands', 'Reception: +404 432 1384<br>Whatsapp: +404 432 1384', 'Office: Brit.saainc@gmail.com', 'SAA Property Management', 'English'],

  footer_link_text: ['Terms & Conditions', 'Privacy Policy'],
  footer_link_href: ['', ''],
  ...
  main_page_north_villa_image_grid_titles: ['Room', 'Room', 'Room', 'Terrace/Patio', 'Terrace/Patio', 'Terrace/Patio'],
  ...
  main_page_north_villa_carousel_titles: ['Bathroom', 'Miscellaneous', 'Private Kitchen', 'Room', 'Room', 'Room', 'Room', 'Room', 'Room', 'Terrace/Patio', 'Terrace/Patio', 'Terrace/Patio'],
